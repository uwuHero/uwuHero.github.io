...
let songs = [
  ...
  ['songs/Asturias.mid', 'Asturias'],
  ['songs/Bydlo.mid', 'Bydlo'],
  ['songs/Deux_arabesques.mid', 'Deux arabesques'],
  ['songs/Erlkonig.mid', 'Erlkonig'],
  ['songs/etude_in_D-sharp_minor.mid', 'etude in D-sharp minor'],
  ['songs/Gnomus.mid', 'Gnomus'],
  ['songs/Habanera.mid', 'Habanera'],
  ['songs/La_fille_aux_cheveux_de_lin.mid', 'La fille aux cheveux de lin'],
  ['songs/Let_Beauty_Awake.mid', 'Let Beauty Awake'],
  ['songs/Night_on_Bald_Mountain.mid', 'Night on Bald Mountain'],
  ['songs/The_Moldau.mid', 'The Moldau'],
  ['songs/Tombeau_de_Couperin_Toccata.mid', 'Tombeau de Couperin Toccata'],
];
